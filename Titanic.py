...
def TitanicLogistic():
    ...
    #step 2 : Analyze data
    print("Visulisation : Survived and non survied passangers");
    figure();
    target = "Survived";
    ...
    countplot(data=titanic_data,x=target,hue="Sex").set_title("Marvellous Infosystem : Survived and non survived passangers based on the Passanger class")
    show()

    print("Visulation : Survived and non survived passangers based on Age");
    figure();
    target = "Survived";

    countplot(data = titanic_data,x=target,hue="Pclass").set_title("Marvellous Infosystem : Survived and non survived passanger based on the Passanger class ");
    show();
